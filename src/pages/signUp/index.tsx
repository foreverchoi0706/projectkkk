...
import { INVALILD_FORMAT_EMAIL, INVALILD_FORMAT_PASSWORD, INVALILD_FORMAT_PHONE, INVALILD_REPASWORD, REQUIRED_EMAIL, REQUIRED_NAME, REQUIRED_PASSWORD, REQUIRED_PHONE } from "@/utils/constants";
...
const Page: FC = () => {
  ...
  >({
    mutationFn: (signUpParams: ISignUpParams) =>
      axiosInstance.post("/member/join", signUpParams),
  ...
  return (
    ...
    >
      ...
      <Form onFinish={onFinish} autoComplete="off">
        <Form.Item<ISignUpParams> name="email" rules={[{ required: true, message: REQUIRED_EMAIL }, {
          type: 'email',
        ...
        <Form.Item<ISignUpParams> name="phone" rules={[{ required: true, message: REQUIRED_PHONE }, {
        ...
        <Form.Item<ISignUpParams> name="password" rules={[{ required: true, message: REQUIRED_PASSWORD }, {
        ...
        <Form.Item<ISignUpParams> name="rePassword" dependencies={['password']} rules={[{ required: true, message: REQUIRED_PASSWORD }, {
          pattern: /^(?=.*[a-zA-Z])(?=.*[0-9])(?=.*[\W_]).{8,}$/,
          message: INVALILD_FORMAT_PASSWORD,
        }, ({ getFieldValue }) => ({
          validator(_, value) {
