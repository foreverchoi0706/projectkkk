...
export const REQUIRED_PRICE_NAME = "가격를 입력해주세요" as const;
export const REQUIRED_SIZE_NAME = "사이즈를 입력해주세요" as const;
export const REQUIRED_COLOR_NAME = "색상를 입력해주세요" as const;
export const REQUIRED_DISCOUNT_RATE_NAME = "할인율를 입력해주세요" as const;
...
export const INVALID_FORMAT_EMAIL = "이메일 형식이 올바르지 않습니다" as const;
